...
{
	[Generator]
	public class VkResponseToRequestParamsGenerator : ISourceGenerator
	{
		/// <inheritdoc />
		public void Initialize(GeneratorInitializationContext context)
		{
			context.RegisterForSyntaxNotifications(() => new VkResponseToRequestParamsReceiver());
		}

		/// <inheritdoc />
		public void Execute(GeneratorExecutionContext context)
		{
			if (context.SyntaxReceiver is not VkResponseToRequestParamsReceiver receiver)
			{
				return;
			}
			...
			context.AddSource($"{nameof(VkResponseToRequestParamsGenerator)}.g.cs",
