...
namespace VkNet.Abstractions.Category
{
	...
	public interface IOrdersCategoryAsync
	{
		...
		/// </remarks>
		Task<IEnumerable<VotesAmount>> GetAmountAsync(ulong userId, IEnumerable<string> votes, CancellationToken token = default);
		...
		/// </remarks>
		Task<IEnumerable<Order>> GetByIdAsync(IEnumerable<ulong> orderIds = null, bool? testMode = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<SubscriptionItem> GetUserSubscriptionByIdAsync(ulong userId, ulong subscriptionId, CancellationToken token = default);
		...
		/// </remarks>
		Task<IEnumerable<SubscriptionItem>> GetUserSubscriptionsAsync(ulong userId, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> UpdateSubscriptionAsync(ulong userId, ulong subscriptionId, ulong price, CancellationToken token = default);
	}
}