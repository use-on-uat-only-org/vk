...
namespace VkNet.Abstractions
{
	...
	public interface IExecuteCategoryAsync
	{
		...
		/// </remarks>
		Task<VkResponse> ExecuteAsync(string code, VkParameters vkParameters = default, CancellationToken token = default);
		...
		/// Страница документации ВКонтакте http://vk.com/dev/execute
		/// </remarks>
		Task<T> ExecuteAsync<T>(string code, VkParameters vkParameters = default, CancellationToken token = default);
		...
		/// Страница документации ВКонтакте http://vk.com/dev/execute
		/// </remarks>
		Task<T> StoredProcedureAsync<T>(string procedureName, VkParameters vkParameters, CancellationToken token = default);
	}
}