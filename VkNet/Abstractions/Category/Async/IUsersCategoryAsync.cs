...
namespace VkNet.Abstractions
{
	...
	public interface IUsersCategoryAsync
	{
		...
		/// </remarks>
		Task<VkCollection<User>> SearchAsync(UserSearchParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> IsAppUserAsync(long? userId, CancellationToken token = default);
		...
		/// </remarks>
		Task<ReadOnlyCollection<User>> GetAsync([NotNull] IEnumerable<long> userIds, ProfileFields fields = null, NameCase nameCase = null,
		...
		/// Страница документации ВКонтакте http://vk.com/dev/users.get
		/// </remarks>
		Task<ReadOnlyCollection<User>> GetAsync([NotNull] IEnumerable<string> screenNames, ProfileFields fields = null,
		...
		/// </remarks>
		Task<VkCollection<Group>> GetSubscriptionsAsync(long? userId = null, int? count = null, int? offset = null,
		...
		/// </remarks>
		Task<VkCollection<User>> GetFollowersAsync(long? userId = null, int? count = null, int? offset = null, ProfileFields fields = null,
													NameCase nameCase = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> ReportAsync(long userId, ReportType type, string comment = "", CancellationToken token = default);
		...
		/// </remarks>
		Task<VkCollection<User>> GetNearbyAsync(UsersGetNearbyParams @params, CancellationToken token = default);
	}
}