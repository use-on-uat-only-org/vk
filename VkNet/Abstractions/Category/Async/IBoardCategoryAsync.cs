...
namespace VkNet.Abstractions
{
	...
	public interface IBoardCategoryAsync
	{
		...
		/// </remarks>
		Task<VkCollection<Topic>> GetTopicsAsync(BoardGetTopicsParams @params, bool skipAuthorization = false, CancellationToken token = default);
		...
		/// </remarks>
		Task<TopicsFeed> GetCommentsAsync(BoardGetCommentsParams @params, bool skipAuthorization = false, CancellationToken token = default);
		...
		/// </remarks>
		Task<long> AddTopicAsync(BoardAddTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> DeleteTopicAsync(BoardTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> CloseTopicAsync(BoardTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> OpenTopicAsync(BoardTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> FixTopicAsync(BoardTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> UnFixTopicAsync(BoardTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> EditTopicAsync(BoardEditTopicParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<long> CreateCommentAsync(BoardCreateCommentParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> DeleteCommentAsync(BoardCommentParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> EditCommentAsync(BoardEditCommentParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RestoreCommentAsync(BoardCommentParams @params, CancellationToken token = default);
	}
}