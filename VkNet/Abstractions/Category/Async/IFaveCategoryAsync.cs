...
namespace VkNet.Abstractions
{
	...
	public partial interface IFaveCategoryAsync
	{
		...
		/// </remarks>
		Task<bool> AddLinkAsync(Uri link, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> AddPageAsync(ulong? userId = null, ulong? groupId = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> AddPostAsync(FaveAddPostParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<FaveTag> AddTagAsync(string name, string position, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> AddVideoAsync(long ownerId, long id, string accessKey = null, string @ref = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> EditTagAsync(long id, string name, CancellationToken token = default);
		...
		/// </remarks>
		Task<VkCollection<FaveGetObject>> GetAsync(FaveGetParams @params, CancellationToken token = default);
		...
		Task<VkCollection<FaveGetPagesObject>> GetPagesAsync(FavePageType type = null,
															...
															ulong? offset = null,
															ulong? count = null,
															long? tagId = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemoveArticleAsync(long ownerId, ulong articleId, string @ref = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemoveLinkAsync(string linkId, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemovePageAsync(long? userId = null, long? groupId = null, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemovePostAsync(long ownerId, long id, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemoveProductAsync(long ownerId, long id, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemoveTagAsync(long id, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> RemoveVideoAsync(long ownerId, long id, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> ReorderTagsAsync(IEnumerable<long> ids, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> SetTagsAsync(FaveSetTagsParams @params, CancellationToken token = default);
		...
		/// </remarks>
		Task<bool> TrackPageInteractionAsync(ulong? userId = null, ulong? groupId = null, CancellationToken token = default);
	}
}