...
namespace VkNet.Abstractions
{
	...
	public interface IStreamingCategoryAsync
	{
		...
		/// </remarks>
		Task<ReadOnlyCollection<StreamingStats>> GetStatsAsync(string type, string interval, DateTime? startTime = null,
		...
		/// </remarks>
		Task<bool> SetSettingsAsync(MonthlyLimit monthlyTier, CancellationToken token = default);
		...
		Task<string> GetStemAsync(string word, CancellationToken token = default);
	}
}