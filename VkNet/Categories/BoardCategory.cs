...
namespace VkNet.Categories
{
	...
	public partial class BoardCategory : IBoardCategory
	{
		...
		{
			return _vk.Call(methodName: "board.getTopics",
					new VkParameters
					{
		...
		{
			var response = _vk.Call(methodName: "board.getComments",
				new VkParameters
				{
					{ "group_id", @params.GroupId },
		...
		{
			return _vk.Call(methodName: "board.addTopic",
				new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "title", @params.Title },
		...
		{
			return _vk.Call(methodName: "board.deleteTopic",
		...
		{
			return _vk.Call(methodName: "board.closeTopic",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId }
		...
		{
			return _vk.Call(methodName: "board.openTopic",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId }
		...
		{
			return _vk.Call(methodName: "board.fixTopic",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId }
		...
		{
			return _vk.Call(methodName: "board.unfixTopic",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId }
		...
		{
			return _vk.Call(methodName: "board.editTopic",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId },
		...
		{
			return _vk.Call(methodName: "board.createComment",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId },
		...
		{
			return _vk.Call(methodName: "board.deleteComment",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId },
		...
		{
			return _vk.Call(methodName: "board.editComment",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId },
		...
		{
			return _vk.Call<bool>(methodName: "board.restoreComment",
				parameters: new VkParameters
				{
					{ "group_id", @params.GroupId },
					{ "topic_id", @params.TopicId },
